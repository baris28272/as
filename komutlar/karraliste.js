...
$endif 
$if[$message[1]==çıkar] 
$author[1;Üye Kara Listeden Çıkarıldı;$client[avatar]] 
$description[1;**_\`$usertag[$replaceText[$replaceText[$replaceText[$replaceText[$message[2];<;;-1];@;;-1];!;;-1];>;;-1]]\`_ Başarılı bir şekilde kara listeden çıkarıldı.** ] 
$color[1;RANDOM]
