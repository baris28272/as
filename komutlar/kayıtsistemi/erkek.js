...
$onlyForChannels[$getServerVar[kayıtkanal];{newEmbed:{description:**$customEmoji[emoji_999] <@$authorID> Bu Komutu Yalnızca <@#$getServerVar[kayıtkanal]> Kanalında Kullanabilir**}{color:RANDOM}}]
$onlyIf[$getServerVar[erkekrol]!=0;{newEmbed:{author:$userTag:$userAvatar[$authorID]}{description:**$customEmoji[emoji_999] <@$authorID> Maalesef Bu Sunucuda Erkek Rolü Ayarlanmamış**}{color:RANDOM}}]
