...
;yes]]
$wait[1ms]
$onlyIf[$message[2]=<150001;**$customEmoji[emoji_99] <@$authorID> 150,000 üzerinde oynamana izin veremem**]
...
$onlyIf[0<$message[2];**$customEmoji[emoji_999] <@$authorID> Girdiğin miktar 0 ve altı olmamalı**]
$onlyIf[$isNumber[$message[2]]!=false;**$customEmoji[emoji_999] <@$authorID> Miktar sadece **sayı olmalıdır**]
$onlyIf[$checkCondition[$message[1]==yazı]$checkCondition[$message[1]==tura]!=falsefalse;**$customEmoji[emoji_999] <@$authorID> \`?cf yazı/tura\` seçmelisiniz**]
`
}