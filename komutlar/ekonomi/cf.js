...
;yes]]
$wait[1ms]
$onlyIf[$message[2]=<150000;**$customEmoji[emoji_999] <@$authorID> 150.000 üzerinde oynamana izin veremem**]
$onlyIf[$getGlobalUserVar[para;$authorID]>=$message[2];**$customEmoji[emoji_999] <@$authorID> Maalesef oynadığın miktarda paran bulunmuyor**]
$onlyIf[0<$message[2];**$customEmoji[emoji_999] <@$authorUD> Girdiğin miktar 0 ve altı olmamalı**]
$onlyIf[$isNumber[$message[2]]!=false;**$customEmoji[emoji_999] <$authorID> Miktar sadece sayı olmalıdır**]
$onlyIf[$checkCondition[$message[1]==yazı]$checkCondition[$message[1]==tura]!=falsefalse;**$customEmoji[emoji_999] <@$authorID> \`?cf yazı/tura miktar\` seçmelisiniz**]
`,
};
