...
$color[1;RANDOM]
$description[1;
**$customEmoji[emoj_70] | \`$userTag[$authorID]\` İsimli Kullanıcı \`$userTag[$mentioned[1]]\` Kişisine \`$numberSeparator[$noMentionMessage;,]\` Miktarında Para Gönderdi**
]
...
$onlyIf[$mentioned[1]!=$authorID;**$customEmoji[emoji_71] | $username Kendine Para Yollayazsın**]
...
$suppressErrors[1;**$customEmoji[emoji_71] | $username Doğru Kullanım ?para-gönder @etiket Miktar**]
`,
};
